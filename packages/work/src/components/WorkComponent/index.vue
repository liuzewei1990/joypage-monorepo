...
<script setup>
    ...
    const elStyle = computed(() => props.workComponentItem.elStyle);
    const coName = computed(() => props.workComponentItem.coName);
    const coProps = computed(() => props.workComponentItem.coProps);
</script>
