...
import { LoginFrom } from "@antd/types/views/login";
import { RouterTable } from "@antd/types/api/login";
import { generator } from "@antd/utils/parsingRouter";
import { login, info, menu, logout } from "@antd/api/login";
