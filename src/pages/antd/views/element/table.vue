<template>
    ...
    <tableLayout
        ...
        ref="layout">
        <template v-slot:status="item"> 测试-{{ item.value.text.name }} </template>
        <template #button>
...
<script lang="ts">
    ...
    import { getData, addData, editGetData, editData, delData, upload, options } from "@antd/api/table";
    import tableLayout from "@antd/components/tableLayout/tableLayout.vue";
