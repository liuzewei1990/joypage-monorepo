<template>
    <a-tabs v-model:activeKey="activeKey" type="editable-card" :tabBarGutter="6" @tabClick="jump" @edit="deltab" hide-add class="tabs__view">
...
<script lang="ts">
    ...
    import { TabItem } from "@antd/store/modules/tabs";
