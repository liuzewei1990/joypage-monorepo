                ...
                <div class="header__avatar">
                    <a-avatar>
                        <template #icon>
                            ...
                            <img src="@antd/assets/layout/avatar.png" v-else />
                        </template>
                    </a-avatar>
...
<script lang="ts">
    import router from "@antd/router";
    import { mapState, useStore } from "vuex";
    import aIcon from "@antd/components/aicon/aicon.vue";
    import { defineComponent, watch, computed, onBeforeMount } from "vue";
    import { RouterObj, RouterTable } from "@antd/types/api/login";
