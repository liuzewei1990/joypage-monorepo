<template>
    <a-card class="table__layout">
        ...
        <a-table v-bind="tableProps" :rowKey="rowkey" :dataSource="dataSource" :pagination="page === true ? paging : false" :loading="loading" @change="tableChange">
        ...
        setup(props, context) {
            ...
            const defaultEdit = (e: any) => {
                if (props.editData === undefined) {
                    ...
                    props
                        .editData({ [editKey]: e.text[editKey] })
                        .then((e) => {
